...
function PremiumCarousel() {
  ...
  return (
    <section className="bg-indigo-950 py-10 sm:py-16 lg:py-20 overflow-hidden relative">
      {/* Dynamic Background */}
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-slate-900 transition-all duration-300"
            >
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 h-full items-center">
                ...
                <Link to={`/products/${premiumProducts[currentIndex].id}`} className="relative h-full w-full rounded-3xl overflow-hidden group">
                  ...
                  <img 
                    ...
                    className="w-full h-[240px] sm:h-[400px] md:h-[500px] lg:h-[550px] object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                ...
                <div className="flex flex-col justify-center text-white py-8 lg:py-0">
                  <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 lg:mb-6">
                  ...
                  <div className="flex flex-wrap items-center gap-8 mb-10 pb-10 border-b border-white/10">
                    <div>
                      ...
                      <p className="text-2xl sm:text-3xl font-bold text-white">ETB {premiumProducts[currentIndex].price.toLocaleString()}</p>
                    </div>
                    <div>
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800">
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12 py-10 sm:py-24 lg:py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <motion.div variants={fadeInUp} className="text-center lg:text-left">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold text-white leading-[1.1] mb-4 tracking-tight">
                Discover{' '}
              ...
              <p className="text-sm sm:text-lg text-indigo-100/90 leading-relaxed max-w-lg mx-auto lg:mx-0 mb-8 font-medium">
                Curated collections of electronics, fashion, and lifestyle products delivered to your door.
              </p>
              ...
              {/* Stats */}
              <div className="flex items-center justify-center lg:justify-start gap-6 sm:gap-10 mt-10 pt-8 border-t border-white/10">
                {[
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12 py-8">
          ...
          >
            {[
              ...
              <motion.div variants={fadeInUp} key={badge.title} className="flex items-center gap-3 group cursor-pointer">
                <div className="shrink-0 w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center group-hover:scale-110 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
                  {badge.icon}
                </div>
                <div>
                  <p className="text-xs font-bold text-gray-900 leading-tight">{badge.title}</p>
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
          ...
          >
            <div>
              ...
              <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">Shop by Category</h2>
            </div>
