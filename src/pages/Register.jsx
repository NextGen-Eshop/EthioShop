  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        {/* ── RIGHT — auth card ── */}
        <div className="flex flex-1 items-center justify-center px-4 sm:px-6 py-6 sm:py-10 lg:px-10 bg-white lg:bg-transparent">
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-5 sm:p-8">

            {/* Mobile brand */}
            <div className="lg:hidden mb-6">
              <h1 className="text-2xl font-black text-gray-900 leading-tight">
                Join The <br /><span className="text-indigo-600">EthioShop</span> Community.
              </h1>
            ...
            <div className="flex border-b border-gray-200 mb-4">
              <Link
                to="/login"
                className="pb-2.5 mr-6 text-sm font-medium text-gray-400 border-b-2 border-transparent -mb-px hover:text-gray-600 transition-colors"
              >
                Login
              </Link>
              <button className="pb-2.5 text-sm font-semibold text-gray-900 border-b-2 border-gray-900 -mb-px">
                Sign Up
              </button>
            </div>
            ...
            <div className="flex gap-2 mb-4">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 py-2 border border-gray-200 rounded-lg text-[10px] sm:text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all cursor-pointer"
              >
                <GoogleIcon /> Google
              </button>
              <button
