      ...
      <motion.div variants={fadeInUp} layout>
        ...
        >
          <div className="relative w-40 sm:w-56 shrink-0 overflow-hidden bg-gray-50">
            ...
            />
            {product.badge && (
              <span className="absolute top-3 left-3 px-2.5 py-1 bg-indigo-600 text-white text-[10px] font-bold uppercase tracking-wider rounded-full">
                {product.badge}
              </span>
            )}
          </div>
      ...
      >
        <div className="relative overflow-hidden bg-gray-50 aspect-square">
          ...
          <button
            ...
            style={{ top: product.badge && discount > 0 ? '3.5rem' : product.badge || discount > 0 ? '2.5rem' : '0.75rem' }}
          >
            <HeartIcon />
          </button>
          {/* Hover overlay */}
          ...
          <div className="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300 z-10">
            <div className="bg-white/95 backdrop-blur-sm text-gray-900 text-xs font-bold text-center py-2.5 rounded-xl shadow-lg">
              Quick View
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12 py-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            {hasFilters && (
              <button
                onClick={clearAll}
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-xs font-semibold rounded-xl hover:bg-white/20 transition-all"
              >
          ...
          <div className="flex items-center gap-3 shrink-0 w-full sm:w-auto justify-end">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-gray-200 hover:border-indigo-300 rounded-xl text-xs font-bold text-gray-700 transition-all min-w-[160px] justify-between"
              >
          ...
          {filteredProducts.length > 0 ? (
            <motion.div
              ...
              className={viewMode === 'grid'
                ? 'grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-6'
                : 'flex flex-col gap-4'
              }
            >
